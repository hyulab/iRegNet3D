...
all_pair_list = []
for num_1 in mut_to_consider:
    for num_2 in mut_to_consider:
        if num_2 > num_1:
            if mut_to_consider[num_1][0] == mut_to_consider[num_2][0]:
                all_pair_list.append((num_1, num_2))
